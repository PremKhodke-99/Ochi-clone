...
function Footer() {
    return (
        <footer className='flex gap-5 w-full h-screen bg-zinc-100 p-20 text-black rounded-t-3xl'>
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className='heading'>
                    <h1 className='text-[6vw] uppercase tracking-tighter font-bold leading-none'>Eye-</h1>
                    <h1 className='text-[6vw] uppercase tracking-tighter font-bold leading-none'>Opening</h1>
                </div>
            ...
            <div className="w-1/2">
            <h1 className='text-[6vw] uppercase tracking-tighter font-bold leading-none'>Presentations</h1>
            <div className='social mt-10'>
                {
                    ["Facebook", "Instagram", "Twitter"].map((item) => (
                        <a href="" className="block text-xl underline">{item}</a>
                    ))
                }
            </div>
            </div>
